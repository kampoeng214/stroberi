...
<div class="row no-gutters mt-0">
  ...
  <div class="col-md-10 p-3 pt-2"> <h3><center><i class="fas fa-mug-hot mr-2"></i>COFFEE ADD</center></h3><hr>
  <table class="table"><P>ADD ADMIN COFFEE</P>
  <thead class="thead-dark">
  <tr>
  <form action="tambah.php" method="post" name="form1">
  <table width="80%"  colborder="5">
            <tr> 
            <th scope="col">RFID</td>
                <td class="form"><input type="number" name="rfid"></td>
            </tr>
            <tr> 
            <th scope="col">JENIS</td>
...
mysqli_query($connect, "INSERT into ngopi values('', 'rfid', 'jenis')");
